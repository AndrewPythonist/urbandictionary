    ...
    def __draw_template(self):
        ...
        def category():
            if self.content['category'] == "":
                ...
                self.draw.rectangle(
                    ...
                    fill=colors[self.content['category']])
                self.draw.text((self.width - 32 * 2 - 6 * 2 - width, 55 * 2 - 2 * 2), text=self.content['category'],
                               font=self.cat_font, fill='#FFFFFF')
        ...
        def thumbs():
            ...
            self.draw.text((32 * 2 + 16 * 2 + 16 * 2 + 8 * 2, self.height - 5 * 2 - 29 * 2), fill="#000000",
                           text=str(self.content['thumbs_up']), font=self.thumb_font)
            self.draw.text((32 * 2 + 75 * 2 + 8 * 2 + 16 * 2 + 6.5 * 2, self.height - 5 * 2 - 29 * 2), fill="#000000",
                           text=str(self.content['thumbs_down']), font=self.thumb_font)
    ...
    def __draw_text(self):
        ...
        def set_definition():
            ...
            for line in self.def_lines:
                self.draw.text((32 * 2, 32 * 2 + 25 * 2 + 40 * 2 + 16 * 2 + space), text=line, font=self.def_font,
                               fill="#2C353C")
                space += line_height
        ...
        def set_example():
            ...
            for line in self.ex_lines:
                self.draw.text(
                    ...
                    text=line, font=self.ex_font, fill="#2C353C")
                space += line_height
